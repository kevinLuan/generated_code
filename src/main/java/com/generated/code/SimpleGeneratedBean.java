...
public class SimpleGeneratedBean extends BuildJavaClass {
	 ...
	 * @param packageInfo
	 */
	public String buildJavaBean(List<SimpleJavaType> simpTypeList, Config config) {
		...
		beanEntity.setPackageInfo(config.getPojoPack());
		// 生成package info......
	...
	public void buildGetterAndSetterMethod(List<SimpleJavaType> list, StringBuilder sBuilder) {
		...
		for (SimpleJavaType entity : list) {
			...
			sBuilder.append(
					"public void " + entity.getSetterMethodName() + "(" + entity.getFieldType() + " " + entity.getFieldName()
