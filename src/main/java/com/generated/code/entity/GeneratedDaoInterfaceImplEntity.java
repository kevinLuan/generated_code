...
public class GeneratedDaoInterfaceImplEntity extends JavaBeanBase {
	...
	public void buildCountAllMethod(StringBuilder builder) {
		...
		builder.append(
				"\tString hql=\"select " + simpleJavaType.getFieldName() + " from " + simpleJavaType.getClassName() + "\";\n");
	...
	public void buildDeleteByFristFieldMethod(StringBuilder builder) {
		...
		builder.append(
				"public boolean delete(" + simpleJavaType.getFieldType() + " " + simpleJavaType.getFieldName() + "){\n");
	...
	public GeneratedDaoInterfaceImplEntity(List<SimpleJavaType> simpleTypeList, Config config) {
		this.simpleTypeList = simpleTypeList;
		super.setPackageInfo(config.getDaoPack());
		...
		addImport(config.getDaoPack() + "." + simpleJavaType.getDAOClassName());
	}
